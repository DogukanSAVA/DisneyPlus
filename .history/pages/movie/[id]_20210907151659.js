...
function Movie({ result }) {
   ...
   <section className="relative z-50">
             ...
             <div className="absolute inset-y-28 md:inset-y-auto md:bottom-10 inset-x-4 md:inset-x-12 space-y-6 z-50">
                    ...
                    <button className="text-xs md:text-base bg-[#f9f9f9] text-black flex items-center justify-center py-2.5 px-6 rounded hover:bg-[#c]">
                    <img src="/image/play-icon-black.svg" alt=""/>
                    <span>Play</span>
                    </button> 
