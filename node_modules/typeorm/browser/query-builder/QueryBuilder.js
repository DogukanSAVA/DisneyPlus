        ...
        var _loop_1 = function (alias) {
            ...
            try {
                for (var _m = (e_4 = void 0, __values(alias.metadata.relations)), _o = _m.next(); !_o.done; _o = _m.next()) {
                    ...
                    try {
                        for (var _p = (e_5 = void 0, __values(__spreadArray(__spreadArray([], __read(relation.joinColumns)), __read(relation.inverseJoinColumns)))), _q = _p.next(); !_q.done; _q = _p.next()) {
    ...
    QueryBuilder.prototype.findColumnsForPropertyPath = function (propertyPath) {
        ...
        var _loop_3 = function () {
            ...
            if (alias.metadata.hasRelationWithPropertyPath(part)) {
                ...
                root.push.apply(root, __spreadArray([], __read(part.split("."))));
        ...
        var _loop_4 = function (key) {
            ...
            if (metadata.hasRelationWithPropertyPath(path)) {
                ...
                if (hasAllPrimaryKeys) {
                    ...
                    paths.push.apply(paths, __spreadArray([], __read(subPaths_1)));
                    return "continue";
                }
