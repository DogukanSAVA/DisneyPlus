        ...
        async getAdapter({ session, secret, ...appOptions }) {
            ...
            return {
                ...
                async createUser(profile) {
                    var _a;
                    const userRef = await client.collection("users").add(utils_1.stripUndefined({
                        name: profile.name,
                        email: profile.email,
                        image: profile.image,
                        emailVerified: (_a = profile.emailVerified) !== null && _a !== void 0 ? _a : null,
                    }));
                ...
                async linkAccount(userId, providerId, providerType, providerAccountId, refreshToken, accessToken, accessTokenExpires) {
                    const accountRef = await client.collection("accounts").add(utils_1.stripUndefined({
                        userId,
                        providerId,
                        providerType,
                        providerAccountId,
